    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        <motion.img
          ...
          className="h-10 lg:h-16 object-contain cursor-pointer invert"
          src="/assets/chirag-logo.png"
          alt="Chirag Logo"
        />

        <ul className="hidden lg:flex items-center gap-x-6 font-semibold">
          {["about", "skills", "projects", "internships", "certifications", "contact"].map((section) => (
            <motion.li
              key={section}
              className="group"
              whileHover={{ scale: 1.1 }}
        ...
        {isOpen && (
          ...
          >
            ...
            <ul className="flex flex-col items-start ml-16 mt-28 h-full gap-y-6 font-semibold">
              ...
              <motion.a
                href="/assets/resume-demo.pdf"
                download="resume-demo.pdf"
                target="_blank"
                rel="noopener noreferrer"
